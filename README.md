...
- Библиотека Boost(Для LInux можно установить не весь boost, у только компонент libboost-program-options со всеми зависямостями этого комопнента. Для установки воспользуйтесь инструкциями для своего дистрибутива)
